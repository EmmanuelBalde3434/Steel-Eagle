...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ChvhXWKG.mjs");
...
var manifest = {
	"4acb619768901da9f9c8c18040dfcf74cbb036b3c33bbc3d17e69fbee1085fc8": {
		functionName: "submitScore_createServerFn_handler",
		importer: () => import("./scores-3rxUH38U.mjs")
	},
	"60ee5fa860848cdde9f3f1cd8fb56f89eff113c8b124c51b8c043a2776ff05a5": {
		functionName: "listTopScores_createServerFn_handler",
		importer: () => import("./scores-3rxUH38U.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Dvy-Mjzo.mjs").then((n) => n.t),
